  ...
  en: {
    ...
    portal: {
      ...
      review: {
        ...
        aiResult: 'AI result',
        reviewStatus: 'Physician review',
        pending: 'Awaiting physician confirmation',
        pendingDetail: 'This is a preliminary AI screening result — it carries no clinical weight until a doctor reviews it.',
        confirmed: 'Confirmed by physician',
        modified: 'Modified by physician',
        rejected: 'Rejected by physician',
        reviewedBy: 'Reviewed by',
        reviewedAt: 'on',
        doctorNote: 'Physician note',
        diagnosis: 'Diagnosis',
        triage: 'Triage level',
        triageRed: 'Urgent',
        triageYellow: 'Review',
        triageGreen: 'Routine',
        notScreened: 'No audio recorded',
      },
    },
    modal: {
  ...
  th: {
    ...
    portal: {
      ...
      review: {
        ...
        modified: 'แพทย์แก้ไขผลแล้ว',
        rejected: 'แพทย์ปฏิเสธผลนี้',
